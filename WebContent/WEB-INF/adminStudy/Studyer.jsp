...
<div class="panel panel-default">
    ...
    <div id="collapseOne" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne">
	 ...
	 <ul class="list-group">
	  <li class="list-group-item"><a href="${pageContext.request.contextPath}/teachingControl/stu_program">查看信息</a></li>
	</ul>
      </div>
    </div>	
  </div>	
...
<div style="width:100%; " class="jumbotron">
  <h1 style="text-align: center;" >Hello, Teaching management staff!</h1>
  <p style="text-align: center;">欢迎使用教学人员管理后台</p>

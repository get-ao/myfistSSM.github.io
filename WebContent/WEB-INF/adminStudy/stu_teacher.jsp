			...
			<tbody>
				<c:forEach items="${requestScope.list}" var="list">
					<tr>
						...
						<th><input onclick="change(this)" id="kao" type="text" readonly="readonly" class="form-control" style="height:30px; width: 70px;" value="${list.adviser==''?'未分配老师':list.adviser}" name="kaoqin"/> </th>
						<th>

...
<!-- 标签页组 -->
  ...
  <div class=" tab-content">
    ...
    <c:forEach items="${requestScope.sAttribute}" var="list">
    	<tr>
    		<th scope="row">${list.studentId}</th>
    		<td>${list.studentName}</td>
    		<td>
				<textarea data-toggle="popover" data-trigger="focus" title="周记内容" data-placement="top" data-content="${list.weekly}"   style=" overflow:hidden; border: none; resize: none;" readonly="readonly" rows="1" cols="20">${list.weekly==""?"未填写":list.weekly}</textarea>
			</td>
    </c:forEach>
    </tbody>
    </table>

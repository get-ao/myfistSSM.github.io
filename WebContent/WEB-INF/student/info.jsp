  ...
  <div class=" tab-content">
    ...
    <br>
    	<div class="input-group">
            ...
            <input type="text" readonly="readonly"  class="form-control" value="${requestScope.sAttribute.studentId }" name="student_id" placeholder="学号"/>
		</div> 
		<br>
		<div class="input-group">
			<span class="input-group-addon">姓名：</span>
            <input type="text" readonly="readonly"   class="form-control" value="${requestScope.sAttribute.studentName }"  placeholder="姓名"/>
		</div> 
		<br>
		<div class="input-group">
			<span class="input-group-addon">性别：</span>
            <input type="text" readonly="readonly"   class="form-control" value="${requestScope.sAttribute.studentSex }"  placeholder="性别"/>
		</div> 
		<br>
		<div class="input-group">
			<span class="input-group-addon">班级：</span>
            <input type="text"  readonly="readonly"  class="form-control" value="${requestScope.sAttribute.studentGrade }"  placeholder="班级"/>
		</div> 
		<br>
		<div class="input-group">
			<span class="input-group-addon">成绩：</span>
            <input type="text" readonly="readonly"   class="form-control" value="${requestScope.sAttribute.inspectionResults }"  placeholder="成绩"/>
		</div> 
		<br>
		<div class="input-group">
			<span class="input-group-addon">指导老师：</span>
            <input type="text" readonly="readonly"   class="form-control" value="${requestScope.sAttribute.adviser }"  placeholder="指导老师"/>
		</div> 
		</div>
    </div>
 </div>
